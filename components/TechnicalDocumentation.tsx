...
import { 
  ...
  Layers, Code, Cpu, Calculator, HelpCircle, ArrowUpRight, Copy, Check, ShieldCheck
} from "lucide-react";
...
export default function TechnicalDocumentation() {
  ...
  const navItems = [
    ...
    { id: "interactive", label: "8. Interactive Simulation Suite" },
    { id: "figures", label: "9. Publication Figures Gallery" },
    { id: "code", label: "10. Source Code & Reproducibility" },
    { id: "publications", label: "11. Manuscripts & References" },
  ];

  return (
    <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
      {/* Sticky Table of Contents Sidebar */}
      <div className="lg:col-span-3 sticky top-20 bg-white rounded-xl border border-slate-200 p-4 shadow-sm space-y-3">
      ...
      <div className="lg:col-span-9 space-y-12">
        ...
        <section id="overview" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 1</span>
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs border border-slate-200 rounded-lg overflow-hidden">
              <thead className="bg-slate-100 text-slate-700 font-semibold border-b border-slate-200">
                <tr>
                  <th className="p-3">Imaging Methodology</th>
                  <th className="p-3">Assumed Planet State</th>
                  <th className="p-3">Cloud Handling</th>
                  <th className="p-3">Fidelity (Pearson r)</th>
                  <th className="p-3">Status</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-slate-100">
                <tr className="hover:bg-slate-50">
                  <td className="p-3 font-semibold text-slate-800">Classical Static Deconvolution</td>
                  <td className="p-3 text-slate-600">Static, non-rotating</td>
                  <td className="p-3 text-rose-600">Ignored / zero clouds</td>
                  <td className="p-3 font-mono text-slate-400">N/A (Fails on real data)</td>
                  <td className="p-3"><span className="badge badge-error text-[10px]">Unphysical</span></td>
                </tr>
                <tr className="hover:bg-slate-50">
                  <td className="p-3 font-semibold text-slate-800">Phase-Binned Coaddition</td>
                  <td className="p-3 text-slate-600">Rotates (binned)</td>
                  <td className="p-3 text-amber-600">Averaged as white noise</td>
                  <td className="p-3 font-mono text-slate-600">r = 0.088 ± 0.012</td>
                  <td className="p-3"><span className="badge badge-accent text-[10px]">Severe Smear</span></td>
                </tr>
                <tr className="hover:bg-slate-50 bg-blue-50/50">
                  <td className="p-3 font-semibold text-blue-900">Our Time-Domain Inversion (TDI)</td>
                  <td className="p-3 text-blue-900">Full diurnal spin + tilt</td>
                  <td className="p-3 text-emerald-700 font-medium">Spatio-temporal OU + 16-Craft Deflation</td>
                  <td className="p-3 font-mono font-bold text-emerald-700">r = 0.326 ± 0.034</td>
                  <td className="p-3"><span className="badge badge-success text-[10px]">Continent Recovery</span></td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <section id="optics" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 2</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 items-start">
            <div className="space-y-3 text-xs md:text-sm text-slate-700 leading-relaxed">
              ...
              <div className="p-3 bg-slate-50 border border-slate-200 rounded-lg font-mono text-xs overflow-x-auto">
        ...
        <section id="forward_model" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 3</span>
            <h2 className="text-2xl font-bold text-slate-900">
          ...
          <div className="space-y-4 text-xs md:text-sm text-slate-700 leading-relaxed">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200 rounded-lg font-mono text-xs overflow-x-auto text-center">
        ...
        <section id="inversion" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 4</span>
            <h2 className="text-2xl font-bold text-slate-900">
          ...
          <div className="space-y-4 text-xs md:text-sm text-slate-700 leading-relaxed">
            ...
            <div className="p-4 bg-emerald-50 border border-emerald-200 rounded-xl space-y-2">
              ...
              <div className="p-2 bg-white rounded border border-emerald-200 font-mono text-xs text-center">
        ...
        <section id="cadence" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 5</span>
            <h2 className="text-2xl font-bold text-slate-900">
              ...
              <table className="w-full text-left text-xs border border-slate-200 rounded-lg overflow-hidden">
                <thead className="bg-slate-100 text-slate-700 font-semibold border-b border-slate-200">
                  <tr>
                    ...
                    <th className="p-3">Dwell Time (<LatexMath math="t_s" />)</th>
                    <th className="p-3">Revisits (<LatexMath math="K" />)</th>
                    <th className="p-3">Duty Cycle (<LatexMath math="\eta" />)</th>
                    <th className="p-3">Fidelity (<LatexMath math="r" />)</th>
                    <th className="p-3">SSIM</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-slate-100">
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-800">Single Dwell Baseline</td>
                    <td className="p-3 font-mono">7,200 s</td>
                    <td className="p-3 font-mono">1 pass</td>
                    <td className="p-3 font-mono">99.4%</td>
                    <td className="p-3 font-mono text-rose-600">0.139 ± 0.021</td>
                    <td className="p-3 font-mono">0.052 ± 0.008</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-800">2 Passes</td>
                    <td className="p-3 font-mono">3,600 s</td>
                    <td className="p-3 font-mono">2 passes</td>
                    <td className="p-3 font-mono">98.8%</td>
                    <td className="p-3 font-mono text-slate-700">0.245 ± 0.028</td>
                    <td className="p-3 font-mono">0.078 ± 0.010</td>
                  </tr>
                  <tr className="hover:bg-slate-50 bg-blue-50/40">
                    <td className="p-3 font-semibold text-blue-900">4 Passes (Turyshev Standard)</td>
                    <td className="p-3 font-mono">1,800 s</td>
                    <td className="p-3 font-mono">4 passes</td>
                    <td className="p-3 font-mono">97.6%</td>
                    <td className="p-3 font-mono text-blue-800 font-bold">0.336 ± 0.035</td>
                    <td className="p-3 font-mono">0.116 ± 0.009</td>
                  </tr>
                  <tr className="hover:bg-slate-50 bg-emerald-50/50">
                    <td className="p-3 font-semibold text-emerald-900">8 Passes (Our Recommended Sweet Spot)</td>
                    <td className="p-3 font-mono">900 s</td>
                    <td className="p-3 font-mono">8 passes</td>
                    <td className="p-3 font-mono">95.2%</td>
                    <td className="p-3 font-mono text-emerald-700 font-bold">0.485 ± 0.038</td>
                    <td className="p-3 font-mono font-bold">0.165 ± 0.014</td>
                  </tr>
                  <tr className="hover:bg-slate-50">
                    <td className="p-3 font-semibold text-slate-800">16 Passes (Fast Revisit)</td>
                    <td className="p-3 font-mono">450 s</td>
                    <td className="p-3 font-mono">16 passes</td>
                    <td className="p-3 font-mono">90.9%</td>
                    <td className="p-3 font-mono text-emerald-700 font-bold">0.544 ± 0.041</td>
                    <td className="p-3 font-mono">0.188 ± 0.017</td>
                  </tr>
                </tbody>
              </table>
            </div>
        ...
        <section id="robustness" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 6</span>
            <h2 className="text-2xl font-bold text-slate-900">
        ...
        <section id="targets" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 7</span>
            <h2 className="text-2xl font-bold text-slate-900">
        ...
        {/* Section 8: Interactive Simulators */}
        <section id="interactive" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 8</span>
            <h2 className="text-2xl font-bold text-slate-900">
              Interactive Physics & Inversion Suite
            </h2>
            <p className="text-sm text-slate-500 mt-1">
              Real-time interactive widgets modeling every aspect of SGL time-domain imaging.
            </p>
          </div>

          <div className="space-y-8">
            <SglCylinderSimulator />
            <CadenceExplorer />
            <CloudDeflationDemo />
            <SpinLikelihoodMap />
          </div>
        ...
        {/* Section 9: Figures Gallery */}
        <section id="figures" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 9</span>
            <h2 className="text-2xl font-bold text-slate-900">
        ...
        {/* Section 10: Code & Reproducibility */}
        <section id="code" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 10</span>
            <h2 className="text-2xl font-bold text-slate-900">
        ...
        {/* Section 11: Manuscripts & References */}
        <section id="publications" className="card p-6 md:p-8 space-y-6">
          <div className="border-b border-slate-100 pb-4">
            <span className="badge badge-primary text-xs mb-2">Section 11</span>
            <h2 className="text-2xl font-bold text-slate-900">
